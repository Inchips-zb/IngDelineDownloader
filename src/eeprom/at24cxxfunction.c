...
const static char devDesc[AT24CNumber+1][256] = {
{
"+----------+-------------+--------------------+---------------+---------+\n\
|  Series  |  Capacity   |Device Address Bits | Register Bits |Page Size|\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C01C  |128x8(1K)    |1|0|1|0|A2|A1|A0|R/W|7 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C01D  |128x8(1K)    |1|0|1|0|A2|A1|A0|R/W|7 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C02C  |256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C02D  |256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C04C  |512x8(4K)    |1|0|1|0|A2|A1|P0|R/W|9 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C04D  |512x8(4K)    |1|0|1|0|A2|A1|P0|R/W|9 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C08C  |1024x8(8K)   |1|0|1|0|A2|P1|P0|R/W|10 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C08D  |1024x8(8K)   |1|0|1|0|A2|P1|P0|R/W|10 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C16C  |2048x8(16K)  |1|0|1|0|P2|P1|P0|R/W|11 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C16D  |2048x8(16K)  |1|0|1|0|P2|P1|P0|R/W|11 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C32D  |4096x8(32K)  |1|0|1|0|A2|A1|A0|R/W|12 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C32E  |4096x8(32K)  |1|0|1|0|A2|A1|A0|R/W|12 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C64B  |8192x8(64K)  |1|0|1|0|A2|A1|A0|R/W|13 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C64D  |8192x8(64K)  |1|0|1|0|A2|A1|A0|R/W|13 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C128C |16384x8(128K)|1|0|1|0|A2|A1|A0|R/W|14 bits        |64 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C256C |32768x8(256K)|1|0|1|0|A2|A1|A0|R/W|15 bits        |64 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24C512C |65536x8(512K)|1|0|1|0|A2|A1|A0|R/W|16 bits        |128 bytes|\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CM01  |131072x8(1M) |1|0|1|0|A2|A1|P0|R/W|17 bits        |256 bytes|\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{"|AT24CM02  |262144x8(2M) |1|0|1|0|A2|P1|P0|R/W|18 bits        |256 bytes|\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS01  |128x8(1K)    |1|0|1|0|A2|A1|A0|R/W|7 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS02  |256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS04  |512x8(4K)    |1|0|1|0|A2|A1|P0|R/W|9 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS08  |1024x8(8K)   |1|0|1|0|A2|P1|P0|R/W|10 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS16  |2048x8(16K)  |1|0|1|0|P2|P1|P0|R/W|11 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS32  |4096x8(32K)  |1|0|1|0|A2|A1|A0|R/W|12 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CS64  |8192x8(64K)  |1|0|1|0|A2|A1|A0|R/W|13 bits        |32 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CSW010|128x8(1K)    |1|0|1|0|A2|A1|A0|R/W|7 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CSW020|256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"AT24CSW040|512x8(4K)    |1|0|1|0|A2|A1|P0|R/W|9 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24CSW080|1024x8(8K)   |1|0|1|0|A2|P1|P0|R/W|10 bits        |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24HC02C |256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |8 bytes  |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24HC04B |512x8(4K)    |1|0|1|0|A2|A1|P0|R/W|9 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24MAC402|256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"},

{
"|AT24MAC602|256x8(2K)    |1|0|1|0|A2|A1|A0|R/W|8 bits         |16 bytes |\n\
+----------+-------------+-+-+-+-+--+--+--+---+---------------+---------+\n"}

};
const static uint16_t devAddMask[AT24CNumber]={0xFF,0xFF,0xFF,0xFF,0xFE,0xFE,0xFC,0xFC,0xF8,0xF8,
                                   0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFE,0xFC,0xFF,
                                   0xFF,0xFE,0xFC,0xF8,0xFF,0xFF,0xFF,0xFF,0xFE,0xFC,
                                   0xFF,0xFE,0xFF,0xFF};
const static uint16_t pageBytes[AT24CNumber]={8,8,8,8,16,16,16,16,16,16,32,32,32,32,64,64,128,256,
                                  256,8,8,16,16,16,32,32,8,8,16,16,8,16,16,16};
const static uint32_t pageNums[AT24CNumber]={16, 16, 32, 32, 32, 32, 64, 64, 128, 128, 128, 128, 
                                        256, 256,256, 512, 512, 512, 1024, 16, 32, 32, 64, 
                                        128, 128, 256, 16, 32, 32, 64, 32, 32, 32, 32};
const static uint16_t regAddMask[AT24CNumber]={0x07,0x07,0x07,0x07,0x0F,0x0F,0x0F,0x0F,0x0F,0x0F,
...
uint16_t ReadBytesFromAT24CXX(At24cObjectType *at,uint32_t regAddress,uint8_t *rData,uint16_t rSize)
{
  ...
  at->devAddress=(at->devAddress & devAddMask[at->mode])|temp;
   ...
   size=rSize;
   if(regAdd+size >= 0x8000) size = 0x8000 - regAdd;
   at->Delayms(10);
...
uint16_t  WriteBytesToAT24CXX(At24cObjectType *at,uint32_t regAddress,uint8_t *wData,uint16_t wSize)
{
  ...
  temp=(temp&(~devAddMask[at->mode]));
  at->devAddress=(at->devAddress & devAddMask[at->mode])|temp;
  //platform_printf("addr:%02x,temp:%x,reg:%x\r\n",at->devAddress,temp,regAddress);
  if((wSize <= at->pageSize)&&(wSize<=(at->pageSize - (regAddress&regAddMask[at->mode]))))
  {
    size=wSize;
  }
  else
  {
    size=at->pageSize - (regAddress&regAddMask[at->mode]);
  }
//    platform_printf("Write:\r\n");
//    printf_hexdump(wData,size);
    at->Delayms(10);
   //platform_printf("regAdd:%x,size:%d\r\n",regAdd,size);  
                          ...
                          )
{
  ...
  at->pDveDesTitle = &devDesc[0];
  at->pDveDes = &devDesc[mode+1];
  at->pageSize = pageBytes[mode];
  at->pageNums = pageNums[mode];
  at->Read=read;
  at->Write=write;
  at->Delayms=delayms;
}
