...
typedef void (* f_uart_rx_bytes)(const char *rxbuff, uint8_t len,uint8_t cmpl);
...
*/
void uart_driver_init(UART_TypeDef *port, void *user_data, f_uart_rx_bytes rx_byte_cb);
